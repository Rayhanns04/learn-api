...
<div class="container-admin" style="margin: 100px">
    ...
    <div class="row  animate__animated animate__backInDown">
        ...
        <div class="col col-6 font-weight-bold text-left">
            ...
            <h2 class="tittleTbl" style="font-weight: 700; margin-left: 50px;">BACK | CART MENU DATA</h2>
        </div>
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>{{$data->harga}}</td>
                <td>
                    <a href="/cartItem/{{$data->id}}/edit" class="btn btn-warning btn-sm text-light">EDIT</a>
                    <a href="/cartItem/{{$data->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure Want Delete This Item')">DELETE</a>
                </td>
            </tr>
            @endforeach
